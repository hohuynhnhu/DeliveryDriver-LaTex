...
\begin{table}[H]
    ...
    \begin{tabular}{|c|p{4cm}|p{7cm}|c|}
        ...
        7 & Nguyễn Hoàng Uyển Nhi &fontend app hiển thị map, hiển thị vị trí shipper, định vị shipper, vẽ class diagram websocker, routing-service, vẽ các sơ đồ liên quan đến tối ưu hoá phân bổ lịch trình    &  \\ \hline
    \end{tabular}
\end{table}
