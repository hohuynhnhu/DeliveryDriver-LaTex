...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.5\textheight]{frontmatter/image/websocker-classDiagram.png}
...
\begin{itemize}
    ...
    \begin{itemize}
        ...
        \item \texttt{FilePathStrategy}: Domain service sinh đường dẫn phân vùng theo ngày 
    \end{itemize}
