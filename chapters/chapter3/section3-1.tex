...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.6\textheight]{frontmatter/image/hethong.jpg}
...
\begin{figure}[H]
    \centering
    \includegraphics[height=0.4\textheight]{frontmatter/image/quantridieuphoi.jpg}
...
\subsection{Tối ưu hóa phân bổ theo độ ưu tiên}
