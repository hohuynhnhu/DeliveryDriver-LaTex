...
\subsubsection{Phân tích đo lường mức độ mối quan hệ của địa điểm giao và nhận bằng phân tích giỏ hàng}

Nhằm hỗ trợ việc ra quyết định mở rộng mạng lưới bưu cục, hệ thống áp dụng phương pháp phân tích giỏ hàng để đo lường mức độ liên kết giữa các địa điểm giao và nhận. Thông qua việc phân tích dữ liệu đơn hàng trong một khoảng thời gian nhất định, hệ thống xác định các nhóm địa điểm thường xuyên xuất hiện cùng nhau trong các tuyến giao hàng.

Kết quả phân tích phản ánh nhu cầu vận chuyển tập trung theo khu vực và mức độ phụ thuộc giữa các địa điểm, từ đó làm nổi bật các cụm khu vực có lưu lượng giao nhận cao nhưng chưa được phục vụ tối ưu. Dựa trên các cụm này, hệ thống đề xuất các vị trí tiềm năng để mở thêm bưu cục mới, giúp rút ngắn quãng đường vận chuyển, giảm tải cho các bưu cục hiện hữu và tối ưu chi phí vận hành.
