...
\subsubsection{Thống kê số liệu đơn hàng}

    Admin có thể xem thống kê số liệu đơn hàng theo ngày, tuần, tháng.
    \begin{figure}[H]
        \centering
        ...
        \caption{Giao diện thống kê số liệu đơn hàng}
        \label{fig:order_statistics}
\end{figure}

%\subsubsection{Xử lý và phân công đơn hàng}
...
%     \caption{Giao diện xử lý và phân công đơn hàng}
