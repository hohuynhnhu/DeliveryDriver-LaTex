...
ở trung tâm màn hình. Giao diện bao gồm các trường thông tin: \textit{Họ và tên}, \textit{Email}, \textit{Số điện thoại}, \textit{Mật khẩu} và \textit{Xác nhận mật khẩu}. Nút \textbf{Đăng ký} giúp người dùng dễ dàng hoàn tất quá trình tạo tài khoản. Liên kết \textbf{Đăng nhập} dành cho người đã có tài khoản và tùy chọn quay về trang chủ, đảm bảo tính thuận tiện và dễ sử dụng.
...
\section{Triển khai chức năng dành cho Admin}
...
Giao diện Quản lý đơn hàng – xem chi tiết hiển thị số lượng đơn theo từng trạng thái xử lý gồm: chờ duyệt, chờ lấy hàng, đã lên lịch lấy, đã lấy hàng, hoàn thành và đã hủy. Hiển thị theo danh sách giúp admin dễ dàng theo dõi tiến độ, kiểm soát luồng xử lý và phát hiện các trạng thái tồn đọng.
 ...
 \subsection{Giao diện quản lý bưu cục của admin}
    ...
    \begin{figure}[H]
        ...
        \label{fig:manage_postoffice}
\end{figure}
Giao diện Quản lý bưu cục cho phép quản trị viên theo dõi danh sách các bưu cục trong hệ thống, bao gồm thông tin mã bưu cục, tên, địa chỉ, liên hệ, giờ mở cửa và trạng thái hoạt động. Hệ thống hỗ trợ tìm kiếm, lọc, tạo mới và chỉnh sửa bưu cục, giúp admin quản lý mạng lưới bưu cục một cách tập trung và hiệu quả.
...
\subsection{Giao diện admin duyệt đơn hàng với dịch vụ gửi thẳng cho bưu cục}
    ...
    \begin{figure}[H]
        ...
        \caption{Giao diện duyệt đơn hàng với dịch vụ gửi thẳng cho bưu cục}
        \label{fig:manage_postoffice-2}
\end{figure}
Giao diện Duyệt đơn hàng với dịch vụ gửi thẳng cho bưu cục cho phép quản trị viên theo dõi danh sách các đơn ở trạng thái chờ duyệt, hỗ trợ tìm kiếm và lọc theo mã đơn. Hệ thống cung cấp tùy chọn xử lý gồm gửi hàng tại bưu cục hoặc lấy hàng tận nơi, giúp admin phê duyệt nhanh và quản lý luồng xử lý đơn hàng hiệu quả.
...
\subsubsection{Giao diện xử lý và phân công đơn hàng đột xuất }
...
Giao diện Xử lý sự cố khẩn cấp cho phép admin xử lý các tình huống phát sinh trong quá trình giao nhận, như tai nạn hoặc sự cố bất ngờ của tài xế. Tại đây, admin có thể chuyển đơn hàng từ tài xế gặp sự cố sang tài xế khác phù hợp, ghi nhận loại sự cố và mô tả chi tiết. Thông tin các lịch giao hàng gặp vấn đề cũng được hiển thị song song, giúp đảm bảo việc điều phối và xử lý đơn hàng diễn ra kịp thời, hạn chế gián đoạn dịch vụ.
